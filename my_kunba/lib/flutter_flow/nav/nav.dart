...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CreateBlogWidget.routeName,
          path: CreateBlogWidget.routePath,
          builder: (context, params) => CreateBlogWidget(),
        ),
        FFRoute(
          name: CreateBlogContentWidget.routeName,
          path: CreateBlogContentWidget.routePath,
          builder: (context, params) => CreateBlogContentWidget(),
        ),
        FFRoute(
          name: CreateBlogSettingsWidget.routeName,
          path: CreateBlogSettingsWidget.routePath,
          builder: (context, params) => CreateBlogSettingsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: PreviewBlogWidget.routeName,
          path: PreviewBlogWidget.routePath,
          builder: (context, params) => PreviewBlogWidget(),
        ),
        FFRoute(
          name: ReplyToCommentWidget.routeName,
          path: ReplyToCommentWidget.routePath,
          builder: (context, params) => ReplyToCommentWidget(),
        ),
        FFRoute(
