...
import 'preview_blog_model.dart';
export 'preview_blog_model.dart';

class PreviewBlogWidget extends StatefulWidget {
  const PreviewBlogWidget({super.key});

  static String routeName = 'PreviewBlog';
  static String routePath = '/previewBlog';

  @override
  State<PreviewBlogWidget> createState() => _PreviewBlogWidgetState();
}

class _PreviewBlogWidgetState extends State<PreviewBlogWidget>
    with TickerProviderStateMixin {
  late PreviewBlogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviewBlogModel());
  }
